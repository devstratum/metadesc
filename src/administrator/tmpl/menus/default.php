                                ...
                                <td>
                                    ...
                                    <div class="metadesc-control">
                                        ...
                                        <div class="metadesc-control__item">
                                            <?php $menu_meta_description = ''; ?>
                                            <?php if (isset($item_params->{'menu-meta_description'})) $menu_meta_description = (string) $item_params->{'menu-meta_description'}; ?>
                                            <?php $badge_color = $menu_meta_description ? 'bg-success' : 'bg-danger'; ?>
                                            <?php $desc_count = mb_strlen($menu_meta_description); ?>
                                    ...
                                    <?php $menu_meta_description ? $class_descr = '' : $class_descr = ' hidden'; ?>
                                    <div class="metadesc-description<?php echo $class_descr; ?>">
                                        <span class="icon icon-check-circle"></span>
                                        <span class="text"><?php echo $menu_meta_description; ?></span>
                                    </div>
                                </td>
                                <?php if (Multilanguage::isEnabled()) : ?>
