...
<form action="<?php echo Route::_('index.php?option=com_metadesc&view=categories'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table itemList" id="articleList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_METADESC_CATEGORIES_TABLE_CAPTION'); ?>,
                        ...
                        <?php foreach ($this->items as $i => $item) : ?>
                            <tr class="row<?php echo $i % 2; ?>" id="metadesc_<?php echo (int) $item->id; ?>">
                                <td class="d-none d-sm-table-cell text-center">
                                    <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'categories.', false); ?>
                                </td>
                                <td>
                                    <?php if ($item->checked_out) : ?>
                                        <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'categories.', false); ?>
                                    <?php else: ?>
